...
{
if ("hide".equals(System.getProperty("chess.gui.selection")))
    return;
...
{
if ("hide".equals(System.getProperty("chess.gui.watermark")))
    return;
...
{
if ("hide".equals(System.getProperty("chess.gui.tooltips")))
    flag = false;
if (flag)
